...
TOOLS_DOCUMENT_URL = "https://github.com/ougato/client/tree/master/tools/README.md"
...
def main():
    try:
        ...
        print("Error parametric, please use \"python. " +
    ...
    for opt, arg in opts:
        if opt in ("-h", "--help"):
            webbrowser.open(TOOLS_DOCUMENT_URL)
            sys.exit(2)
        elif opt in("-d", "--del"):
            state = ARG_STATE_DEL
        elif opt in("-n", "--new"):
