 ...
 * LastEditors  : ougato
 * LastEditTime : 2024-01-09 00:52:22
...
export namespace DBConfig {
    ...
    // 版本
    export const VERSION: number = 13;
    // 结构
    export const Struct: DBInterface.Table[] = [
        ...
        },
        {
            ...
            fieldList: [
                ...
                { name: DBDefine.ActionField.ACTION_TYPE, keyPath: DBDefine.ActionField.ACTION_TYPE, isIndex: true, type: DBDefine.FieldType.INTEGER, options: { unique: false } },
                { name: DBDefine.ActionField.ACTION_DATA, keyPath: DBDefine.ActionField.ACTION_DATA, isIndex: false, type: DBDefine.FieldType.BLOB, options: { unique: false } },
            ]
        },
        {
        ...
        },
        {
            ...
            fieldList: [
                ...
                { name: DBDefine.RecordField.RECORD_TYPE, keyPath: DBDefine.RecordField.RECORD_TYPE, isIndex: true, type: DBDefine.FieldType.INTEGER, options: { unique: false } },
                { name: DBDefine.RecordField.RECORD_DATA, keyPath: DBDefine.RecordField.RECORD_DATA, isIndex: false, type: DBDefine.FieldType.BLOB, options: { unique: false } },
            ]
        },
    ];
